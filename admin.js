...
(function initSession() {
  // admin.html already redirected to admin-login.html if this is missing —
  // this just reads the session set there to show the signed-in name.
  let session = null;
  try { session = JSON.parse(localStorage.getItem("yourheart_admin_session")); } catch (e) {}
...
document.getElementById("logoutLink").addEventListener("click", (e) => {
  e.preventDefault();
  localStorage.removeItem("yourheart_admin_session");
